...
noise_level_range = 0.12; 
num_trials = length(noise_level_range);

% --- KHỞI TẠO TRƯỚC VÒNG LẶP SNR ---
nRuns = 10; % Số lượng bề mặt khác nhau muốn chạy kiểm thử (ví dụ: 50)
numAlgorithms = 4; % Số lượng thuật toán (Goldstein, Qual, WLS, Proposed)
RMSE = zeros(nRuns, numAlgorithms); 
...
title('(a)');
xlabel('Surface Index','FontSize',11,'FontWeight','bold');
ylabel('RMSE (rad)','FontSize',11,'FontWeight','bold');
